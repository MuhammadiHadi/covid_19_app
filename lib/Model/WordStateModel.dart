...
/// updated : 1670753331100
/// cases : 653519369
/// todayCases : 200246
/// deaths : 6658177
/// todayDeaths : 320
/// recovered : 629002213
/// todayRecovered : 133529
/// active : 17858979
/// critical : 37496
/// casesPerOneMillion : 83840
/// deathsPerOneMillion : 854.2
/// tests : 6854974984
/// testsPerOneMillion : 862810.84
/// population : 7944933753
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2247.84
/// recoveredPerOneMillion : 79170.23
/// criticalPerOneMillion : 4.72
/// affectedCountries : 230

WordStateModel wordStateModelFromJson(String str) =>
    WordStateModel.fromJson(json.decode(str));
String wordStateModelToJson(WordStateModel data) => json.encode(data.toJson());
...
class WordStateModel {
  ...
  WordStateModel.fromJson(dynamic json) {
